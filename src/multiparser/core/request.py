class Request:
    ...
    def __init__(self, parser: 'Parser', args: tuple = None, kwargs: dict = None, **kwg):
        self.parent_idx = None
        self.parser = parser
        self.args = args or tuple()
        self.kwargs = kwargs or dict()
        self.total_parts = kwg.get('total_parts', 1)
        self.current_part = kwg.get('current_part', 0)

    def is_last(self):
        return self.total_parts == self.current_part + 1

    def __call__(self, single_driver: 'SingleDriver'):
